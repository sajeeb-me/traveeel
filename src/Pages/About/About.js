        ...
        <div className='min-h-[90vh] px-5 md:px-[120px] flex justify-center items-center'>
            <section className='grid grid-cols-1 md:grid-cols-2 items-center gap-10'>
                ...
                <div className='text-left'>
                    <h1 className='text-4xl font-bold text-sky-700 mb-5'>Sajeeb Das Shuvo</h1>
                    <p><span className='font-semibold'>My Goal: </span>I am a Student now. Within next 8 months before this  2022 end I want to become a Junior Full-Stack Developer.</p>
